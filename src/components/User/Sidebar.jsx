    ...
    return (
        <>
            ...
            {/* <div className="sm:hidden">
                <button onClick={toggleSidebar} className="text-gray-500 hover:text-gray-600 focus:outline-none focus:text-gray-600">
            ...
            {/* Sidebar */}
            <aside id="logo-sidebar" className={`fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform ${isOpen ? '' : '-translate-x-full'} bg-white border-r border-gray-300 shadow-2xl sm:translate-x-0`} aria-label="Sidebar">
                <div className="h-full px-3 pb-4 overflow-y-auto bg-white">
                    <ul className="space-y-2 font-medium">
                        {/* dashboard */}
                        <li>
                            <a href="#" className="flex items-center p-2 hover:bg-gray-100 group">
                        ...
                        <li>
                            <a href="#" className="flex items-center p-2 rounded-lg group">
                                <svg className="flex-shrink-0 w-5 h-5 text-blue-600 transition duration-75 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="m17.418 3.623-.018-.008a6.713 6.713 0 0 0-2.4-.569V2h1a1 1 0 1 0 0-2h-2a1 1 0 0 0-1 1v2H9.89A6.977 6.977 0 0 1 12 8v5h-2V8A5 5 0 1 0 0 8v6a1 1 0 0 0 1 1h8v4a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-4h6a1 1 0 0 0 1-1V8a5 5 0 0 0-2.582-4.377ZM6 12H4a1 1 0 0 1 0-2h2a1 1 0 0 1 0 2Z" />
                                </svg>
                                <span className="flex-1 ms-3 whitespace-nowrap">Inbox</span>
                                <span className="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-bold text-white bg-blue-600 rounded-full">3</span>
                            </a>
                        </li>
                        {/* users */}
                        <li>
                            <a href="#" className="flex items-center p-2 rounded-lg group">
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Attendance list</span>
                            </a>
                        </li>
                        {/* products */}
                        <li>
